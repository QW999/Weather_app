...
def search():
    ...
    if weather:
        ...
        messagebox.showerror('Error', 'Cannot find city ...SAREAN{}'.format(city))
...
search_btn = Button(app, text='Search weather', width=12, comand=search())
search_btn.pack()


location_lbl = Label(app, text='', font=('bolt', 20))
location_lbl.pack()
